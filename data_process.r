...
data_ <- readMat("/Users/apple/Desktop/Mouse/an198503_2013_03_01_data_struct.mat")
...
#Recorded trials
saveRDS(mouse[[1]][10][[1]][[3]][[2]][[1]][6][[1]][1,], "/Users/apple/Desktop/Mouse/recorded_trials.rds")
#Recorded timings
saveRDS(mouse[[1]][10][[1]][[3]][[2]][[1]][5][[1]][1,], "/Users/apple/Desktop/Mouse/recorded_timings.rds")
#Recorded values
saveRDS(mouse[[1]][10][[1]][[3]][[2]][[1]][7][[1]], "/Users/apple/Desktop/Mouse/recorded_values.rds")

#touches times
"Protraction contacts for c1"
...
"Protraction contacts for c4"
"Retraction contacts for c4"
touches_timing <- c()
...
saveRDS(touches_timing, "/Users/apple/Desktop/Mouse/touches_timing.rds")
saveRDS(touches_trials, "/Users/apple/Desktop/Mouse/touches_trials.rds")
...
saveRDS(pole_timing, "/Users/apple/Desktop/Mouse/pole_timing.rds")
saveRDS(pole_trials, "/Users/apple/Desktop/Mouse/pole_trials.rds")
#reward cues
reward_timing <- mouse[[1]][11][[1]][3][[1]][[7]][[1]][6][[1]][1,]
reward_trials <- mouse[[1]][11][[1]][3][[1]][[7]][[1]][7][[1]][1,]

saveRDS(reward_timing, "/Users/apple/Desktop/Mouse/reward_timing.rds")
saveRDS(reward_trials, "/Users/apple/Desktop/Mouse/reward_trials.rds")
...
#Recorded trials
recorded_trials <- readRDS("/Users/apple/Desktop/Mouse/recorded_trials.rds")
#Recorded timings
recorded_timings <- readRDS("/Users/apple/Desktop/Mouse/recorded_timings.rds")
#Recorded values
recorded_values <- readRDS("/Users/apple/Desktop/Mouse/recorded_values.rds")


touches_timings <- readRDS("/Users/apple/Desktop/Mouse/touches_timing.rds")
touches_trials <- readRDS("/Users/apple/Desktop/Mouse/touches_trials.rds")

pole_timings <- readRDS("/Users/apple/Desktop/Mouse/pole_timing.rds")
pole_trials <- readRDS("/Users/apple/Desktop/Mouse/pole_trials.rds")


reward_timings <- readRDS("/Users/apple/Desktop/Mouse/reward_timing.rds")
reward_trials <- readRDS("/Users/apple/Desktop/Mouse/reward_trials.rds")


matching_rate_for_all_neurons <- readRDS('/Users/apple/Desktop/Mouse/matching_rate_for_all_neurons.rds')
...
frac_results <- rep(0, length(22:28))
s_ <- 1
for (frac_ in 22:28) {
...
G_ <- G_generator(22 + which(frac_results == min(frac_results))[1] - 1)
